...
* [Assembleash - WebAssembly and Typescript-like languages playground](https://github.com/MaxGraey/Assembleash) ⚠️ Archived
...
* [Uno Platform Bootcamp - single-source WASM & Mobile app tutorial (2019)](https://github.com/unoplatform/workshops/tree/master/uno-bootcamp) ⭐ 99 | 🐛 12 | 🌐 C# | 📅 2025-10-08
...
* [AssemblyScript - Definitely not a TypeScript to WebAssembly compiler](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,990 | 🐛 199 | 🌐 WebAssembly | 📅 2026-07-22
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,643 | 🐛 559 | 🌐 Go | 📅 2026-08-12
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,596 | 🐛 560 | 🌐 WebAssembly | 📅 2026-08-13
* [Asterius - A Haskell to WebAssembly compiler](https://github.com/tweag/asterius) ⚠️ Archived
* [Bytecoder - A Rich Domain Model for Java Bytecode and Framework to interpret and transpile it to other languages such as JavaScript, OpenCL or WebAssembly](https://github.com/mirkosertic/Bytecoder) ⭐ 940 | 🐛 40 | 🌐 Java | 📅 2026-08-08
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 20,951 | 🐛 222 | 🌐 Rust | 📅 2026-08-12
  * [Wasmer for Go](https://github.com/wasmerio/go-ext-wasm) ⭐ 2,949 | 🐛 79 | 🌐 Go | 📅 2025-02-01
  * [Wasmer for Python](https://github.com/wasmerio/python-ext-wasm) ⭐ 2,149 | 🐛 74 | 🌐 Rust | 📅 2023-09-17
  * [Wasmer for PHP](https://github.com/wasmerio/php-ext-wasm) ⭐ 1,052 | 🐛 19 | 🌐 PHP | 📅 2024-02-27
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,505 | 🐛 849 | 🌐 Rust | 📅 2026-08-12
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,771 | 🐛 191 | 🌐 C++ | 📅 2026-08-12
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,596 | 🐛 560 | 🌐 WebAssembly | 📅 2026-08-13
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,098 | 🐛 230 | 🌐 C++ | 📅 2026-08-12
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 7,972 | 🐛 64 | 🌐 C | 📅 2026-08-12
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,063 | 🐛 601 | 🌐 C | 📅 2026-08-12
* [Extism - the universal plug-in system to make your software programmable](https://github.com/extism/extism) ⭐ 5,714 | 🐛 51 | 🌐 Rust | 📅 2026-07-16
* [Manticore - Symbolic execution engine with support for WebAssembly](https://github.com/trailofbits/manticore) ⚠️ Archived
* [WAVM - WebAssembly virtual machine, designed for use in non-web applications](https://github.com/WAVM/WAVM) ⭐ 2,773 | 🐛 28 | 🌐 C++ | 📅 2026-04-05
* [wagon - WebAssembly interpter written in Go](https://github.com/go-interpreter/wagon) ⚠️ Archived
* [Asmble - WebAssembly on the JVM](https://github.com/cretz/asmble) ⭐ 658 | 🐛 20 | 🌐 Kotlin | 📅 2023-06-16
...
* [Owi - a Wasm interpreter written in OCaml](https://github.com/OCamlPro/owi) ⭐ 319 | 🐛 157 | 🌐 OCaml | 📅 2026-08-10
* [fizzy - Fast, deterministic, and pedantic WebAssembly interpreter written in clean C++17](https://github.com/wasmx/fizzy) ⭐ 240 | 🐛 64 | 🌐 C++ | 📅 2025-11-10
...
* [embly - A serverless web application framework for collaboration and scale](https://github.com/embly/embly) ⚠️ Archived
* [warpy - WebAssembly in RPython](https://github.com/kanaka/warpy) ⭐ 66 | 🐛 3 | 🌐 Python | 📅 2019-04-16
* [windtrap - A WASM VM written in Elixir](https://github.com/gballet/windtrap) ⭐ 19 | 🐛 4 | 🌐 Elixir | 📅 2020-01-05
* [pywebassembly - WebAssembly interpreter written in pure Python](https://github.com/poemm/pywebassembly) ⭐ 12 | 🐛 1 | 🌐 WebAssembly | 📅 2020-03-18
...
* [mod\_wasm - An extension module for the Apache HTTP Server that enables the usage of WebAssembly (Wasm).](https://github.com/vmware-labs/mod_wasm) ⭐ 114 | 🐛 21 | 🌐 Rust | 📅 2024-05-31

### Web frameworks-libraries

* [Yew - Rust framework for making client web apps](https://github.com/DenisKolodin/yew) ⭐ 32,783 | 🐛 114 | 🌐 Rust | 📅 2026-08-10
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,101 | 🐛 80 | 🌐 Rust | 📅 2026-08-10
...
* [go-vdom-wasm - Webassembly VDOM to create web application using Golang(experimental)](https://github.com/mfrachet/go-vdom-wasm) ⭐ 83 | 🐛 0 | 🌐 Go | 📅 2020-01-14
...
* [jq-web - the JSON processing tool jq ported to the web with Emscripten](https://github.com/fiatjaf/jq-web) ⭐ 363 | 🐛 13 | 🌐 JavaScript | 📅 2025-03-19

### WebGL

* [ammo.js - direct port of the Bullet physics engine to JavaScript using Emscripten](https://github.com/kripken/ammo.js) ⭐ 4,550 | 🐛 175 | 🌐 C++ | 📅 2026-06-16
* [glas - Web**GL** in WebAssembly with **A**ssembly**S**cript, by LUME](https://github.com/lume/glas) ⭐ 940 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-05
...
* [wasm-loader - WASM webpack loader](https://github.com/ballercat/wasm-loader) ⚠️ Archived
* [cpp-wasm-loader - C/C++ to WASM Webpack loader optimized for small bundle sizes](https://github.com/ClickSimply/cpp-wasm-loader) ⭐ 133 | 🐛 1 | 🌐 JavaScript | 📅 2021-04-27

### Browserify

* [rustify - Rust WebAssembly transform for Browserify](https://github.com/browserify/rustify) ⭐ 492 | 🐛 5 | 🌐 JavaScript | 📅 2024-12-21

### Node.js

* [webassembly - A minimal toolkit and runtime to produce and run WebAssembly modules.](https://github.com/dcodeIO/webassembly) ⭐ 806 | 🐛 15 | 🌐 C | 📅 2019-11-01
* [xwasm - WebAssembly Packager and WASM tooling for modern frontend](https://github.com/raphamorim/xwasm) ⭐ 55 | 🐛 26 | 🌐 JavaScript | 📅 2023-01-04
* [go-wasm-cli - Minimalistic cli to create and run (with hot reload) Go application targeting WASM](https://github.com/mfrachet/go-wasm-cli) ⭐ 40 | 🐛 3 | 🌐 JavaScript | 📅 2022-12-03
* [wasm-pack - pack up the wasm and publish it to npm!](https://github.com/ashleygwilliams/wasm-pack) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2023-09-28

### .NET

* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,010 | 🐛 1,506 | 🌐 C# | 📅 2026-08-13
* [Ooui.Wasm - A Xamarin.Forms backend for WebAssembly, using C#/XAML on top of mono-wasm](https://github.com/praeclarum/Ooui) ⭐ 1,622 | 🐛 110 | 🌐 C# | 📅 2022-12-07

### Others

* [wasm-pdf – Generate PDF files with JavaScript/WASM](https://github.com/jussiniinikoski/wasm-pdf) ⚠️ Archived
* [wasm-bpf - A WebAssembly eBPF library, toolchain and runtime to help you build eBPF programs to Wasm and run in kernel.](https://github.com/eunomia-bpf/wasm-bpf) ⭐ 442 | 🐛 6 | 🌐 Rust | 📅 2026-07-22
* [Argon2 in browser - Argon2 library compiled for browser runtime](https://github.com/antelle/argon2-browser) ⭐ 439 | 🐛 20 | 🌐 JavaScript | 📅 2023-03-24
...
* [ssheasy - An online ssh and sft client](https://github.com/hullarb/ssheasy) ⭐ 409 | 🐛 3 | 🌐 Go | 📅 2026-02-23
* [webm-wasm - Create webm videos in JavaScript via WebAssembly](https://github.com/GoogleChromeLabs/webm-wasm) ⭐ 408 | 🐛 34 | 🌐 C++ | 📅 2026-05-30
...
* [WasmBench - A large dataset of real-world WebAssembly binaries, collected from the Web, GitHub, NPM and more](https://github.com/sola-st/WasmBench) ⭐ 75 | 🐛 1 | 🌐 Python | 📅 2022-07-20
* [hunspell-asm - Wasm based JS binding for Hunspell spellchecker](https://github.com/kwonoj/hunspell-asm) ⭐ 74 | 🐛 22 | 🌐 TypeScript | 📅 2023-01-14
* [Eufa - a high efficient utility functions library written in webassembly](https://github.com/becavalier/eufa) ⚠️ Archived
* [wasm-bindgen - Interoperating JS and Rust code](https://github.com/alexcrichton/wasm-bindgen) ⭐ 25 | 🐛 0 | 🌐 Rust | 📅 2023-05-15
...
* [funge.js - A Befunge JIT](https://github.com/serprex/befunge) ⭐ 21 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-12

### Forth

* [WAForth - Bootstrapping Dynamic Forth Interpreter/Compiler for & in WebAssembly](https://github.com/remko/waforth) ⭐ 589 | 🐛 8 | 🌐 WebAssembly | 📅 2025-07-15

### Go

* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 135,739 | 🐛 10,224 | 🌐 Go | 📅 2026-08-13
...
* [AssemblyScript - A subset of TypeScript that compiles to WebAssembly](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,990 | 🐛 199 | 🌐 WebAssembly | 📅 2026-07-22
...
* [wasm\_lua - Lua VM running in a WASM environment](https://github.com/vvanders/wasm_lua) ⭐ 803 | 🐛 5 | 🌐 C | 📅 2023-11-29
* [wasmoon - a high level Lua VM with JS bindings](https://github.com/ceifa/wasmoon) ⭐ 691 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-29

### OCAML

* [ocamlrun-wasm - OCaml Bytecode Interpreter in WASM](https://github.com/sebmarkbage/ocamlrun-wasm) ⭐ 257 | 🐛 1 | 🌐 Shell | 📅 2017-03-06
* [wasicaml - Translate OCaml Bytecode to WASM](https://github.com/remixlabs/wasicaml/) ⭐ 135 | 🐛 28 | 🌐 OCaml | 📅 2026-05-04
* [Wasocaml - OCaml to WasmGC compiler](https://github.com/OCamlPro/wasocaml) ⭐ 65 | 🐛 5 | 🌐 OCaml | 📅 2024-10-27

### Python

* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,784 | 🐛 400 | 🌐 Python | 📅 2026-08-12
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,814 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,415 | 🐛 5,610 | 🌐 Rust | 📅 2026-08-13
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,168 | 🐛 24 | 🌐 Rust | 📅 2026-08-11
...
* [Walt - Alternative Syntax for WebAssembly](https://github.com/ballercat/walt) ⭐ 4,632 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-02
* [wah - a slightly higher-level language superset of webassembly](https://github.com/tmcw/wah) ⭐ 159 | 🐛 0 | 🌐 Clojure | 📅 2019-07-28
* [wam - Superset of wast syntax that is more convenient for humans to write directly](https://github.com/kanaka/wam) ⭐ 64 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-07

### Other

* [Never - statically typed, embeddable functional programming language](https://github.com/never-lang/never) ⭐ 461 | 🐛 2 | 🌐 C | 📅 2024-05-12
* [Lys - a functional language that compiles to WebAssembly](https://github.com/lys-lang/lys) ⭐ 429 | 🐛 7 | 🌐 TypeScript | 📅 2025-01-24

## Tools

### Editor

* [vim-wasm - WebAssembly filetype support for Vim](https://github.com/rhysd/vim-wasm) ⭐ 85 | 🐛 1 | 🌐 Vim Script | 📅 2023-11-25
...
* [WABT - A suite of tools that help working with WASM binary files](https://github.com/WebAssembly/wabt) ⭐ 8,098 | 🐛 230 | 🌐 C++ | 📅 2026-08-12
* [Owi - A WebAssembly toolkit and cross-language bug-finder](https://github.com/OCamlPro/owi) ⭐ 319 | 🐛 157 | 🌐 OCaml | 📅 2026-08-10
...
* [webassembly-examples](https://github.com/mdn/webassembly-examples) ⭐ 1,209 | 🐛 3 | 🌐 WebAssembly | 📅 2026-07-08
* [Gameboy emulator written in Rust and compiled to WebAssembly](https://github.com/raphamorim/gameboy) ⭐ 890 | 🐛 3 | 🌐 Rust | 📅 2025-08-04
* [Boytacean - A fast Game Boy Emulator written in Rust and running in the Browser using WebAssembly](https://github.com/joamag/boytacean) ⭐ 679 | 🐛 9 | 🌐 Rust | 📅 2026-08-09
...
* [webassembly-examples - From Simple To Complex.](https://github.com/reklatsmasters/webassembly-examples) ⭐ 202 | 🐛 2 | 🌐 JavaScript | 📅 2017-11-30
* [D3 force layout with WebAssembly](https://github.com/ColinEberhardt/d3-wasm-force/blob/master/README.md) ⭐ 109 | 🐛 0 | 🌐 TypeScript | 📅 2017-10-31
* [CppOpenGLWebAssemblyCMake - C++/OpenGL/OpenAL/GLFW/GLM based app built with CMake to native or WebAssembly](https://github.com/lukka/CppOpenGLWebAssemblyCMake) ⭐ 75 | 🐛 0 | 🌐 HTML | 📅 2022-04-16
* [HandyTools - A tool providing features like base64 encoding/decoding, Unix time conversion, etc. Written in Go + WebAssembly](https://github.com/XD-DENG/handytools-go-webassembly) ⭐ 68 | 🐛 0 | 🌐 Go | 📅 2021-03-22
* [wasm-intro - Tiny WebAssembly Examples with LLVM/clang and C](https://github.com/bzar/wasm-intro) ⭐ 45 | 🐛 0 | 🌐 C | 📅 2017-05-25
* [HackerNews PWA with wasm-bindgen](https://github.com/ragingwind/wasm-hnpwa) ⭐ 14 | 🐛 0 | 🌐 Rust | 📅 2019-08-11
...
* [WebAssembly Reference Manual](https://github.com/sunfishcode/wasm-reference-manual) ⭐ 613 | 🐛 3 | 📅 2023-01-26
...
* [Bringing the Web up to Speed with WebAssembly](https://github.com/WebAssembly/spec/blob/master/papers/pldi2017.pdf) ⭐ 3,437 | 🐛 93 | 🌐 WebAssembly | 📅 2026-08-12
...
* [C/C++面向wasm编程 - 第一本中文开源图书](https://github.com/3dgen/cppwasm-book) ⭐ 1,400 | 🐛 7 | 🌐 C++ | 📅 2024-04-17
* [WebAssembly资料精选 - 中文版](https://github.com/chai2010/awesome-wasm-zh) ⭐ 1,034 | 🐛 2 | 🌐 WebAssembly | 📅 2024-10-12
* [WebAssembly标准入门 - 第一本中文图书](https://github.com/chai2010/awesome-wasm-zh/blob/master/webassembly-primer.md) ⭐ 1,034 | 🐛 2 | 🌐 WebAssembly | 📅 2024-10-12
