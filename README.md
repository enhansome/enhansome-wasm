...
* [AssemblyScript - Definitely not a TypeScript to WebAssembly compiler](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,022 | 🐛 204 | 🌐 WebAssembly | 📅 2026-09-14
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,736 | 🐛 544 | 🌐 Go | 📅 2026-09-19
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,628 | 🐛 563 | 🌐 WebAssembly | 📅 2026-09-18
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 21,035 | 🐛 267 | 🌐 Rust | 📅 2026-09-19
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,645 | 🐛 844 | 🌐 Rust | 📅 2026-09-18
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,801 | 🐛 149 | 🌐 C++ | 📅 2026-09-18
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,628 | 🐛 563 | 🌐 WebAssembly | 📅 2026-09-18
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,134 | 🐛 233 | 🌐 C++ | 📅 2026-09-18
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 8,028 | 🐛 19 | 🌐 C | 📅 2026-09-19
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,105 | 🐛 603 | 🌐 C | 📅 2026-09-18
* [Extism - the universal plug-in system to make your software programmable](https://github.com/extism/extism) ⭐ 5,763 | 🐛 55 | 🌐 Rust | 📅 2026-09-02
...
* [Owi - a Wasm interpreter written in OCaml](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-19
...
* [Yew - Rust framework for making client web apps](https://github.com/DenisKolodin/yew) ⭐ 32,805 | 🐛 120 | 🌐 Rust | 📅 2026-09-18
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,230 | 🐛 36 | 🌐 Rust | 📅 2026-09-18
...
* [ammo.js - direct port of the Bullet physics engine to JavaScript using Emscripten](https://github.com/kripken/ammo.js) ⭐ 4,571 | 🐛 176 | 🌐 C++ | 📅 2026-09-08
...
* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,052 | 🐛 1,680 | 🌐 C# | 📅 2026-09-18
...
* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 138,883 | 🐛 10,154 | 🌐 Go | 📅 2026-09-19
...
* [AssemblyScript - A subset of TypeScript that compiles to WebAssembly](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,022 | 🐛 204 | 🌐 WebAssembly | 📅 2026-09-14
...
* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,836 | 🐛 394 | 🌐 Python | 📅 2026-09-18
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,436 | 🐛 15 | 🌐 Rust | 📅 2026-09-19 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,554 | 🐛 5,629 | 🌐 Rust | 📅 2026-09-19
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,307 | 🐛 35 | 🌐 Rust | 📅 2026-09-17
...
* [WABT - A suite of tools that help working with WASM binary files](https://github.com/WebAssembly/wabt) ⭐ 8,134 | 🐛 233 | 🌐 C++ | 📅 2026-09-18
* [Owi - A WebAssembly toolkit and cross-language bug-finder](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-19
...
* [Bringing the Web up to Speed with WebAssembly](https://github.com/WebAssembly/spec/blob/master/papers/pldi2017.pdf) ⭐ 3,453 | 🐛 96 | 🌐 WebAssembly | 📅 2026-09-11
