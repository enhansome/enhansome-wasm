...
* [AssemblyScript - Definitely not a TypeScript to WebAssembly compiler](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,014 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-03
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,725 | 🐛 556 | 🌐 Go | 📅 2026-09-13
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,623 | 🐛 569 | 🌐 WebAssembly | 📅 2026-09-12
* [Asterius - A Haskell to WebAssembly compiler](https://github.com/tweag/asterius) ⚠️ Archived
* [Bytecoder - A Rich Domain Model for Java Bytecode and Framework to interpret and transpile it to other languages such as JavaScript, OpenCL or WebAssembly](https://github.com/mirkosertic/Bytecoder) ⭐ 961 | 🐛 41 | 🌐 Java | 📅 2026-08-31
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 21,026 | 🐛 270 | 🌐 Rust | 📅 2026-09-13
  * [Wasmer for Go](https://github.com/wasmerio/go-ext-wasm) ⭐ 2,949 | 🐛 79 | 🌐 Go | 📅 2025-02-01
  * [Wasmer for Python](https://github.com/wasmerio/python-ext-wasm) ⭐ 2,152 | 🐛 74 | 🌐 Rust | 📅 2023-09-17
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,634 | 🐛 849 | 🌐 Rust | 📅 2026-09-13
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,804 | 🐛 159 | 🌐 C++ | 📅 2026-09-12
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,623 | 🐛 569 | 🌐 WebAssembly | 📅 2026-09-12
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,126 | 🐛 241 | 🌐 C++ | 📅 2026-09-06
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 8,025 | 🐛 18 | 🌐 C | 📅 2026-09-12
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,090 | 🐛 601 | 🌐 C | 📅 2026-09-10
* [Extism - the universal plug-in system to make your software programmable](https://github.com/extism/extism) ⭐ 5,758 | 🐛 53 | 🌐 Rust | 📅 2026-09-02
* [Manticore - Symbolic execution engine with support for WebAssembly](https://github.com/trailofbits/manticore) ⚠️ Archived
* [WAVM - WebAssembly virtual machine, designed for use in non-web applications](https://github.com/WAVM/WAVM) ⭐ 2,779 | 🐛 29 | 🌐 C++ | 📅 2026-04-05
...
* [Owi - a Wasm interpreter written in OCaml](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09
...
* [Yew - Rust framework for making client web apps](https://github.com/DenisKolodin/yew) ⭐ 32,803 | 🐛 119 | 🌐 Rust | 📅 2026-09-11
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,193 | 🐛 40 | 🌐 Rust | 📅 2026-09-09
...
* [asdom - DOM bindings for AssemblyScript, write DOM code just like in TypeScript, but compiled to WebAssembly, by LUME](https://github.com/lume/asdom) ⭐ 110 | 🐛 2 | 🌐 TypeScript | 📅 2024-06-16
...
* [ammo.js - direct port of the Bullet physics engine to JavaScript using Emscripten](https://github.com/kripken/ammo.js) ⭐ 4,566 | 🐛 175 | 🌐 C++ | 📅 2026-09-08
...
* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,051 | 🐛 1,694 | 🌐 C# | 📅 2026-09-13
...
* [ssheasy - An online ssh and sft client](https://github.com/hullarb/ssheasy) ⭐ 415 | 🐛 3 | 🌐 Go | 📅 2026-02-23
* [webm-wasm - Create webm videos in JavaScript via WebAssembly](https://github.com/GoogleChromeLabs/webm-wasm) ⭐ 409 | 🐛 34 | 🌐 C++ | 📅 2026-05-30
...
* [WasmBench - A large dataset of real-world WebAssembly binaries, collected from the Web, GitHub, NPM and more](https://github.com/sola-st/WasmBench) ⭐ 76 | 🐛 1 | 🌐 Python | 📅 2022-07-20
...
* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 138,695 | 🐛 10,136 | 🌐 Go | 📅 2026-09-12
...
* [AssemblyScript - A subset of TypeScript that compiles to WebAssembly](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,014 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-03
...
* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,829 | 🐛 400 | 🌐 Python | 📅 2026-09-09
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,329 | 🐛 12 | 🌐 Rust | 📅 2026-09-12 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,512 | 🐛 5,620 | 🌐 Rust | 📅 2026-09-12
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,301 | 🐛 31 | 🌐 Rust | 📅 2026-09-01
...
* [WABT - A suite of tools that help working with WASM binary files](https://github.com/WebAssembly/wabt) ⭐ 8,126 | 🐛 241 | 🌐 C++ | 📅 2026-09-06
* [Owi - A WebAssembly toolkit and cross-language bug-finder](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09
...
* [webassembly-examples](https://github.com/mdn/webassembly-examples) ⭐ 1,212 | 🐛 3 | 🌐 WebAssembly | 📅 2026-08-30
...
* [Bringing the Web up to Speed with WebAssembly](https://github.com/WebAssembly/spec/blob/master/papers/pldi2017.pdf) ⭐ 3,452 | 🐛 95 | 🌐 WebAssembly | 📅 2026-09-11
