...
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,758 | 🐛 536 | 🌐 Go | 📅 2026-09-20
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,630 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-21
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 21,038 | 🐛 266 | 🌐 Rust | 📅 2026-09-21
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,651 | 🐛 849 | 🌐 Rust | 📅 2026-09-21
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,802 | 🐛 156 | 🌐 C++ | 📅 2026-09-21
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,630 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-21
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,136 | 🐛 234 | 🌐 C++ | 📅 2026-09-18
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 8,029 | 🐛 19 | 🌐 C | 📅 2026-09-19
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,109 | 🐛 606 | 🌐 C | 📅 2026-09-21
* [Extism - the universal plug-in system to make your software programmable](https://github.com/extism/extism) ⭐ 5,768 | 🐛 55 | 🌐 Rust | 📅 2026-09-02
...
* [Yew - Rust framework for making client web apps](https://github.com/DenisKolodin/yew) ⭐ 32,813 | 🐛 120 | 🌐 Rust | 📅 2026-09-18
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,238 | 🐛 37 | 🌐 Rust | 📅 2026-09-18
...
* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,056 | 🐛 1,664 | 🌐 C# | 📅 2026-09-21
...
* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 138,918 | 🐛 10,163 | 🌐 Go | 📅 2026-09-21
...
* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,839 | 🐛 394 | 🌐 Python | 📅 2026-09-18
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,480 | 🐛 9 | 🌐 Rust | 📅 2026-09-20 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,560 | 🐛 5,637 | 🌐 Rust | 📅 2026-09-21
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,309 | 🐛 34 | 🌐 Rust | 📅 2026-09-21
...
* [WABT - A suite of tools that help working with WASM binary files](https://github.com/WebAssembly/wabt) ⭐ 8,136 | 🐛 234 | 🌐 C++ | 📅 2026-09-18
