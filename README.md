...
* [AssemblyScript - Definitely not a TypeScript to WebAssembly compiler](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,002 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-03
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,694 | 🐛 569 | 🌐 Go | 📅 2026-09-04
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,618 | 🐛 560 | 🌐 WebAssembly | 📅 2026-09-04
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 21,013 | 🐛 251 | 🌐 Rust | 📅 2026-09-04
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,594 | 🐛 845 | 🌐 Rust | 📅 2026-09-04
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,792 | 🐛 158 | 🌐 C++ | 📅 2026-09-04
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,618 | 🐛 560 | 🌐 WebAssembly | 📅 2026-09-04
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,117 | 🐛 231 | 🌐 C++ | 📅 2026-08-30
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 8,017 | 🐛 18 | 🌐 C | 📅 2026-09-04
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,085 | 🐛 604 | 🌐 C | 📅 2026-09-04
* [Extism - the universal plug-in system to make your software programmable](https://github.com/extism/extism) ⭐ 5,753 | 🐛 53 | 🌐 Rust | 📅 2026-09-02
...
* [Owi - a Wasm interpreter written in OCaml](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-09-04
...
* [Yew - Rust framework for making client web apps](https://github.com/DenisKolodin/yew) ⭐ 32,791 | 🐛 114 | 🌐 Rust | 📅 2026-09-04
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,168 | 🐛 55 | 🌐 Rust | 📅 2026-09-04
...
* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,033 | 🐛 1,678 | 🌐 C# | 📅 2026-09-04
...
* [wasm-bpf - A WebAssembly eBPF library, toolchain and runtime to help you build eBPF programs to Wasm and run in kernel.](https://github.com/eunomia-bpf/wasm-bpf) ⭐ 445 | 🐛 5 | 🌐 Rust | 📅 2026-09-04
...
* [ssheasy - An online ssh and sft client](https://github.com/hullarb/ssheasy) ⭐ 413 | 🐛 3 | 🌐 Go | 📅 2026-02-23
...
* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 137,504 | 🐛 10,144 | 🌐 Go | 📅 2026-09-03
...
* [AssemblyScript - A subset of TypeScript that compiles to WebAssembly](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,002 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-03
...
* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,819 | 🐛 399 | 🌐 Python | 📅 2026-09-02
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,183 | 🐛 10 | 🌐 Rust | 📅 2026-09-03 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,496 | 🐛 5,640 | 🌐 Rust | 📅 2026-09-04
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,280 | 🐛 27 | 🌐 Rust | 📅 2026-09-01
...
* [Owi - A WebAssembly toolkit and cross-language bug-finder](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-09-04
...
* [webassembly-examples](https://github.com/mdn/webassembly-examples) ⭐ 1,211 | 🐛 3 | 🌐 WebAssembly | 📅 2026-08-30
* [Gameboy emulator written in Rust and compiled to WebAssembly](https://github.com/raphamorim/gameboy) ⭐ 892 | 🐛 3 | 🌐 Rust | 📅 2025-08-04
* [Boytacean - A fast Game Boy Emulator written in Rust and running in the Browser using WebAssembly](https://github.com/joamag/boytacean) ⭐ 679 | 🐛 10 | 🌐 Rust | 📅 2026-08-30
...
* [Bringing the Web up to Speed with WebAssembly](https://github.com/WebAssembly/spec/blob/master/papers/pldi2017.pdf) ⭐ 3,445 | 🐛 95 | 🌐 WebAssembly | 📅 2026-09-03
