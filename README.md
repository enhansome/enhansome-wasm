...
* [AssemblyScript - Definitely not a TypeScript to WebAssembly compiler](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,989 | 🐛 201 | 🌐 WebAssembly | 📅 2026-07-22
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,664 | 🐛 561 | 🌐 Go | 📅 2026-08-22
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,607 | 🐛 559 | 🌐 WebAssembly | 📅 2026-08-22
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 20,965 | 🐛 234 | 🌐 Rust | 📅 2026-08-21
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,557 | 🐛 852 | 🌐 Rust | 📅 2026-08-21
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,779 | 🐛 175 | 🌐 C++ | 📅 2026-08-22
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,607 | 🐛 559 | 🌐 WebAssembly | 📅 2026-08-22
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,103 | 🐛 225 | 🌐 C++ | 📅 2026-08-21
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 7,992 | 🐛 40 | 🌐 C | 📅 2026-08-23
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,072 | 🐛 604 | 🌐 C | 📅 2026-08-22
...
* [Owi - a Wasm interpreter written in OCaml](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20
...
* [Yew - Rust framework for making client web apps](https://github.com/DenisKolodin/yew) ⭐ 32,784 | 🐛 114 | 🌐 Rust | 📅 2026-08-10
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,130 | 🐛 60 | 🌐 Rust | 📅 2026-08-10
...
* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,017 | 🐛 1,549 | 🌐 C# | 📅 2026-08-23
...
* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 136,184 | 🐛 10,116 | 🌐 Go | 📅 2026-08-23
...
* [AssemblyScript - A subset of TypeScript that compiles to WebAssembly](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,989 | 🐛 201 | 🌐 WebAssembly | 📅 2026-07-22
...
* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,799 | 🐛 397 | 🌐 Python | 📅 2026-08-22
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,950 | 🐛 7 | 🌐 Rust | 📅 2026-08-22 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,441 | 🐛 5,625 | 🌐 Rust | 📅 2026-08-23
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,172 | 🐛 24 | 🌐 Rust | 📅 2026-08-11
...
* [WABT - A suite of tools that help working with WASM binary files](https://github.com/WebAssembly/wabt) ⭐ 8,103 | 🐛 225 | 🌐 C++ | 📅 2026-08-21
* [Owi - A WebAssembly toolkit and cross-language bug-finder](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20
