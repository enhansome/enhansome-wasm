...
* [TinyGo - Go for embedded devices and WebAssembly.  Creates very small .wasm files.](https://github.com/aykevl/tinygo) ⭐ 17,790 | 🐛 532 | 🌐 Go | 📅 2026-09-26
* [Binaryen - Binaryen is a compiler and toolchain infrastructure library for WebAssembly, written in C++](https://github.com/WebAssembly/binaryen) ⭐ 8,643 | 🐛 572 | 🌐 WebAssembly | 📅 2026-09-25
...
* [Wasmer - Standalone JIT WebAssembly Runtime](https://github.com/wasmerio/wasmer) ⭐ 21,092 | 🐛 281 | 🌐 Rust | 📅 2026-09-26
...
* [wasmtime - Standalone WebAssembly Runtime](https://github.com/CraneStation/wasmtime) ⭐ 18,659 | 🐛 834 | 🌐 Rust | 📅 2026-09-26
* [SSVM - WebAssembly Virtual Machine for AI and Blockchain applications](https://github.com/second-state/SSVM) ⭐ 10,806 | 🐛 149 | 🌐 C++ | 📅 2026-09-26
* [binaryen - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/binaryen) ⭐ 8,643 | 🐛 572 | 🌐 WebAssembly | 📅 2026-09-25
* [wabt - WebAssembly toolkit and interpreter written in C++](https://github.com/webassembly/wabt) ⭐ 8,144 | 🐛 232 | 🌐 C++ | 📅 2026-09-21
* [wasm3 - The fastest WebAssembly interpreter (x86, x64, ARM, MIPS, Xtensa)](https://github.com/wasm3/wasm3) ⭐ 8,035 | 🐛 18 | 🌐 C | 📅 2026-09-25
* [wamr - WebAssembly Micro Runtime (WAMR) is an AOT/JIT/interpreter focusing on small footprint](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,119 | 🐛 613 | 🌐 C | 📅 2026-09-22
* [Extism - the universal plug-in system to make your software programmable](https://github.com/extism/extism) ⭐ 5,778 | 🐛 55 | 🌐 Rust | 📅 2026-09-02
...
* [Perspective - Streaming pivot visualization via WebAssembly](https://github.com/jpmorganchase/perspective) ⭐ 11,253 | 🐛 37 | 🌐 Rust | 📅 2026-09-25
...
* [Uno Platform - An implementation of Microsoft's UWP APIs for iOS/Android/WebAssembly/Linux/macOS, using C#/XAML on top of mono-wasm](https://github.com/nventive/Uno) ⭐ 10,057 | 🐛 1,747 | 🌐 C# | 📅 2026-09-26
...
* [Go - Go programming language WebAssembly support](https://github.com/golang/go/wiki/WebAssembly) ⭐ 139,027 | 🐛 10,238 | 🌐 Go | 📅 2026-09-26
...
* [Pyodide - The Python scientific stack running in the browser](https://github.com/iodide-project/pyodide) ⭐ 14,857 | 🐛 396 | 🌐 Python | 📅 2026-09-23
...
* [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,563 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 (*has scattered references to targeting WASM*)
* [Ruffle - Adobe Flash Player emulator written in the Rust](https://github.com/ruffle-rs/ruffle) ⭐ 18,578 | 🐛 5,645 | 🌐 Rust | 📅 2026-09-26
* [wasmi - WebAssembly interpreter in pure Rust](https://github.com/paritytech/wasmi) ⭐ 2,312 | 🐛 37 | 🌐 Rust | 📅 2026-09-21
...
* [WABT - A suite of tools that help working with WASM binary files](https://github.com/WebAssembly/wabt) ⭐ 8,144 | 🐛 232 | 🌐 C++ | 📅 2026-09-21
...
* [Bringing the Web up to Speed with WebAssembly](https://github.com/WebAssembly/spec/blob/master/papers/pldi2017.pdf) ⭐ 3,458 | 🐛 96 | 🌐 WebAssembly | 📅 2026-09-25
